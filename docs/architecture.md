...
```text
DeepSeek Harness v0.1.5-rc.1 boot/profile/patch loader
...
The pinned `0.1.5-rc.1` cohort is newer than `0.1.0-rc.8`, `0.1.2-rc.1`, and
`0.1.3-alpha.2`. The apparent incompatibility with plugins declaring ranges such
...
`0.1.5-rc.1` does not satisfy that range even though SemVer orders it later.
