...
export type OplStudioSurface = {
  ...
  renderSettings(destination: SettingsDestinationId, renderContribution?: RenderSettingsContribution, onNavigate?: (destination: SettingsDestinationId) => void): ReactNode;
